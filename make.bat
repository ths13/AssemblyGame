...
ml  /c  /coff  /Cp Samus_Aran.asm || goto :error

ml  /c  /coff  /Cp Samus_Aran2.asm || goto :error

ml  /c  /coff  /Cp metroid.asm || goto :error

ml  /c  /coff  /Cp wall_medium.asm || goto :error

ml  /c  /coff  /Cp screw_attack1.asm || goto :error

link /SUBSYSTEM:WINDOWS  /LIBPATH:%MASMLIBPATH% game.obj blit.obj trig.obj lines.obj stars.obj Samus_Aran.obj Samus_Aran2.obj metroid.obj wall_medium.obj screw_attack1.obj libgame.obj
